...
### Time-based UI guards (2025-11-06)
- Cancellation window: cancel disabled within 60 minutes of start; enforced in UI and before server call (MyAppointmentsScreen).
- Slot lists: 60s focused re-check already in SelectTimeSlot and MyAppointments; SelectDate list refetch remains in place.
- Online consult CTA: placeholder note; to be enabled in future with same helper window if/when added.
### Import cleanup (2025-11-06)
- MyAppointmentsScreen: removed duplicate `isPastSlot` import; verified no local shadowing, hooks remain at top.
